...
class UsersImport implements ToCollection, WithHeadingRow, SkipsEmptyRows, WithValidation, SkipsOnFailure, SkipsOnError
{
    ...
    */
    ...
    {
        if(!DateTime::createFromFormat('d-m-Y',$data['dob'])) {
