        ...
        @foreach ($failuresArray as $failure)
            <tr>
                ...
                @if (in_array('first_name', $failure['attribute']))
                    <td style="color: red">{{ isset($failure['values']['first_name']) ? $failure['values']['first_name'] : '' }}</td>
                @else
                    <td>{{$failure['values']['first_name']}}</td>
                @endif

                @if (in_array('last_name', $failure['attribute']))
                    <td style="color: red">{{ isset($failure['values']['last_name']) ? $failure['values']['last_name'] : ''}}</td>
                @else
                    <td>{{$failure['values']['last_name']}}</td>
                @endif

                @if (in_array('email', $failure['attribute']))
                    <td style="color: red">{{ isset($failure['values']['email']) ? $failure['values']['email'] : '' }}</td>
                @else
                    <td>{{$failure['values']['email']}}</td>
                @endif

                @if (in_array('state', $failure['attribute']))
                    <td style="color: red">{{ isset($failure['values']['state']) ? $failure['values']['state'] : '' }}</td>
                @else
                    <td>{{$failure['values']['state']}}</td>
                @endif

                @if (in_array('dob', $failure['attribute']))
                    <td style="color: red">{{ isset($failure['values']['dob']) ? $failure['values']['dob'] : '' }}</td>
                @else
                    <td>{{$failure['values']['dob']}}</td>
                @endif

                @if (in_array('fav_playing_spot', $failure['attribute']))
                    <td style="color: red">{{ isset($failure['values']['fav_playing_spot']) ? $failure['values']['fav_playing_spot'] : '' }}</td>
                @else
                    <td>{{$failure['values']['fav_playing_spot']}}</td>
                @endif

                @if (in_array('specialization', $failure['attribute']))
                    <td style="color: red">{{ isset($failure['values']['specialization']) ? $failure['values']['specialization'] : '' }}</td>
                @else
                    <td>{{$failure['values']['specialization']}}</td>
                @endif

                @if (in_array('batting_hand', $failure['attribute']))
                    <td style="color: red">{{ isset($failure['values']['batting_hand']) ? $failure['values']['batting_hand'] : '' }}</td>
                @else
                    <td>{{$failure['values']['batting_hand']}}</td>
                @endif

                @if (in_array('jersey_number', $failure['attribute']))
                    <td style="color: red">{{ isset($failure['values']['jersey_number']) ? $failure['values']['jersey_number'] : '' }}</td>
                @else
                    <td>{{$failure['values']['jersey_number']}}</td>
                @endif

                @if (in_array('balling_hand', $failure['attribute']))
                    <td style="color: red">{{ isset($failure['values']['balling_hand']) ? $failure['values']['balling_hand'] : '' }}</td>
                @else
                    <td>{{$failure['values']['balling_hand']}}</td>
                @endif

                @if (in_array('balling_type', $failure['attribute']))
                    <td style="color: red">{{ isset($failure['values']['balling_type']) ? $failure['values']['balling_type'] : '' }}</td>
                @else
