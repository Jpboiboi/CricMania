...
@section('main-content')
    <div class="container-fluid bg-dark text-warning pb-1">
        <div class="container bg-dark text-warning">
            <h1 class="mb-5 font-1">Player Stats</h1>
            <div class="row">
                <div class="col-md-6">
                    @isset($playerStat->player->photo_path)
                        <img src="{{$playerStat->player->photo_path}}" alt="">
                        @else
                        <img src="{{ asset('assets/img/player-avatar.png') }}" class="rounded-circle bg-light" alt="" width="200px">
                    @endisset
                    <h2 class="text-light"> {{ $playerStat->player->first_name }} {{ $playerStat->player->last_name }}</h2>
                </div>
